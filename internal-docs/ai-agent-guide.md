# AI Agent Guide — Astra Hooks

## Quick Start for AI Agents

1. **Entry point:** Start at `astra-hooks.php` to understand plugin initialization
...
4. **Text domain:** Use `astra-hooks` for all translatable strings
...
1. Wrap strings in `__( 'text', 'astra-hooks' )` or `esc_html__( 'text', 'astra-hooks' )`
...
- [ ] Text domain `astra-hooks` used for all user-facing strings
