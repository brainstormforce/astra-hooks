# Architecture — Astra Hooks

## Overview

Astra Hooks is a WordPress plugin that follows standard WordPress plugin architecture patterns.

## Entry Point

The plugin entry point is `astra-hooks.php`, which:
...
1. WordPress loads the plugin via `astra-hooks.php`
